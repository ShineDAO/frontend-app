    ...
    <Details theme={theme}>
      ...
      >
        {({ values, touched, errors, setFieldValue, isSubmitting }) => (
          <Form>
            <br />
            <h1>Subscribe to our mailing list for updates about our upcoming token launches!</h1>
            ...
            {values.email && (
              <InputFieldCaptcha>
                <FastField component={Recaptcha} sitekey={process.env.GATSBY_PORTFOLIO_RECAPTCHA_KEY} name="recaptcha" onChange={value => setFieldValue("recaptcha", value)} />
