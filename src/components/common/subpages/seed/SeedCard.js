  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", paddingTop: 50 }}>
      <StatsCard background="black" border="1px solid white">
        <div>{getEligibilityStatus(accessMechanism, capPerAddressEnabled, capPerAddress, nftBalance, nttBalance, hasValidNtt, accessTokenBalance, tier1Cap)}</div>
                ...
                {vestedBalance && vestedBalance > 0 && chainId === project.technicalDetails[currentStatus].network && (
                  <div>
                    <FlexBox>
                     ...
                     {(cliffPeriod != vestingPeriod) && <Text margin="0 0 0 10px" color="#aeaeae">
                        {" "}
